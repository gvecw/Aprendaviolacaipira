...
# 5. Step 3 (I dont know the original text fully, so I will match the remaining <h3> and <p> inside this block using index targeting or find a wildcard for exactly step 3)
# To handle Step 3, let's just find the text after Step 2.
# Step 3 might be "OUÇA NO CARRO", etc.
# I will use a regex replacing the 3rd h3 block inside this section.
# Actually, let's just run another script to see the Step 3 text, it's safer.
